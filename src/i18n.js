const UI = {
  en: {
    ...
    atlasProject: 'Atlas project', backToBrowse: 'Back', filterField: 'Filter field', legendTitle: 'Present condition',
  ...
  el: {
    ...
    atlasProject: 'Το έργο του άτλαντα', backToBrowse: 'Πίσω', filterField: 'Πεδίο φίλτρου', legendTitle: 'Σημερινή κατάσταση',
