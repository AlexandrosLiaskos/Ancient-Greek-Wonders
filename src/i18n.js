const UI = {
  en: {
    ...
    country: 'Modern country', status: 'Condition', all: 'All', sevenOnly: 'Seven Wonders only',
    refineAtlas: 'Refine atlas', countryShort: 'Country',
    statusShort: 'Condition', sevenShort: 'Seven Wonders', searchFilterOptions: 'Search filter options',
    noFilterOptions: 'No filter options match.', activeFilters: 'Active filters',
    backToBrowse: 'Back', filterField: 'Filter field', legendTitle: 'Present condition',
  ...
  el: {
    ...
    country: 'Σύγχρονη χώρα', status: 'Κατάσταση', all: 'Όλα', sevenOnly: 'Μόνο τα Επτά Θαύματα',
    refineAtlas: 'Φίλτρα άτλαντα', countryShort: 'Χώρα',
    statusShort: 'Κατάσταση', sevenShort: 'Επτά Θαύματα', searchFilterOptions: 'Αναζήτηση επιλογών φίλτρου',
    noFilterOptions: 'Δεν βρέθηκαν επιλογές φίλτρου.', activeFilters: 'Ενεργά φίλτρα',
    backToBrowse: 'Πίσω', filterField: 'Πεδίο φίλτρου', legendTitle: 'Σημερινή κατάσταση',
